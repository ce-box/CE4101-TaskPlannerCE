...
function Header() {
  ...
  return (
    <header className="header">
      <div className="image" />
      <div className="help_student" onClick={help}></div>
      <div className="notification_student" onClick={notification}></div>
      <div className="profile_student" onClick={profile}></div>
      ...
      <div className="profile_popup">
        ...
        <NavLink className="navbar-item" to="/Student/Profile">
          Your Profile
        </NavLink>
        <hr className="separator" />
